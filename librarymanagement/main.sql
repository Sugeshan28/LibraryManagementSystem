...
issued_emp_id varchar(7));

-- creating member 
create table members(member_id varchar(7) primary key ,
...
alter table branch modify column contact_no varchar(14);
...
INSERT INTO returnstatus (return_id, issued_id, return_date)  VALUES
